...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer__social">
            ...
            <a href="https://github.com/Davidgr04" target="_blank" style="color: black;" class="footer__social-link">Github Alumno</a>
            <a href="https://github.com/albertetpx" target="_blank" style="color: black;" class="footer__social-link">Github Profesor</a>
        </div>
    </div>
</footer>
</body>
